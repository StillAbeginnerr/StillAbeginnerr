...
|--------------|-----------------------------------------------------------------------------------------------|------------------------------------------------------------------------|
| Evanth    | `Next.js` `Tavily` `LLMs API` <br>Semi-autonomous agentic productivity assistant, Initially Multiple Models Provider  | www.evanth.io |
...
| -------------------------------------------------------------------------------------- | --------------------------- | ----------------------------------------------------------------------------------------------------------- | ------------------ | -------------------------------------------------------------------------- | ------- | ------------- |
| Stealth AI Startup                                                                     | Full Stack Developer Intern | `FastAPI` `Next.js` `Jest` `Java` <br>Built reusable components and tests                       | May – Present 2025 | 20+ PRs merged<br>Shipped modular features<br>Wrote unit/integration tests | Remote(India)  | San Francisco, USA |
...
| 💻 Qualessence Technologies                                                            | Full Stack Developer Intern | `Next.js` `PostgreSQL` `Wix Analytics` `LLM APIs`<br>Agile delivery and performance optimization            | Jul – Dec 2024     | 40% faster render time<br>35% boost in user inquiries, apart from client projects, redeveloped company's website with LLM integration                      | Remote  | India         |
...
| 🧠 AI Platform | Evanth AI                  | 18+ premium models • Combined Multiple Models and their Contexts into one chat • $20.0/month subscription| ✅ www.evanth.in |
| 💬 Agentic AI  |  Flight Finder AI     | Recommendation System • Unified Multiple APIs • Flight on your convenience | ✅ www.airtravelsearch.com |
